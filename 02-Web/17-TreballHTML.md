...
Cal desenvolupar el treball en grups de dues persones, però diferent als grups de Pixelmator.

La temàtica de la web ha de ser un joc de taula, assegura't que no el fa ningú més del teu grup (DAM, DAW, MIX).

## Pàgines

Constarà de cinc pàgines.
...
- El Copyright alineat a la dreta
...
- Un vídeo de YouTube on es veu el joc en funcionament
- Footer
...
Teniu molt temps, entregueu algo "professional", **l'estètica comptarà nota**.
...
4. Enllaç al Proxmos on es pot veure la pàgina també al Moodle
